...
export const AUDIT_ACTION_OPTIONS = [
  ...
  { value: "AUTH_PASSWORD_CHANGED", label: "AUTH_PASSWORD_CHANGED" },
  { value: "AUTH_FORCE_PASSWORD_CHANGE_COMPLETED", label: "AUTH_FORCE_PASSWORD_CHANGE_COMPLETED" },
  { value: "ADMIN_USER_CREATED", label: "ADMIN_USER_CREATED" },
  { value: "ADMIN_USER_UPDATED", label: "ADMIN_USER_UPDATED" },
  { value: "ADMIN_USER_ROLE_CHANGED", label: "ADMIN_USER_ROLE_CHANGED" },
  { value: "ADMIN_USER_STATUS_CHANGED", label: "ADMIN_USER_STATUS_CHANGED" },
  { value: "ADMIN_USER_PASSWORD_RESET", label: "ADMIN_USER_PASSWORD_RESET" },
  { value: "ADMIN_USER_FORCE_PASSWORD_CHANGE_SET", label: "ADMIN_USER_FORCE_PASSWORD_CHANGE_SET" },
