...
VALUES (
    ...
    '+10000000003',
    'admin@admin.com',
    '$2a$12$Bg6AoFm9xeRRCiRld/SwdOcjBPBvvruK0L9uTFxU7U6Z1GuBdiCWS',
    'SUPER_ADMIN',
    'ACTIVE'
)
ON CONFLICT (id) DO UPDATE SET
...
-- School admin: schooladmin@admin.com / password (assigned to Sunshine Kindergarten)
INSERT INTO users (id, full_name, phone, email, password_hash, role, status)
VALUES (
    '11111111-1111-1111-1111-111111111107',
    'School Admin',
    '+10000000004',
    'schooladmin@admin.com',
    '$2a$12$Bg6AoFm9xeRRCiRld/SwdOcjBPBvvruK0L9uTFxU7U6Z1GuBdiCWS',
    'SCHOOL_ADMIN',
    'ACTIVE'
)
