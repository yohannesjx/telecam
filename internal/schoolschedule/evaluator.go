...
type scheduleStore interface {
	GetSchoolScheduleSettings(ctx context.Context, schoolID uuid.UUID) (sqlc.SchoolScheduleSettings, error)
}
...
func settingsFromRow(row sqlc.SchoolScheduleSettings) (*Settings, error) {
	pauseReason := ""
